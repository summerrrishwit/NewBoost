...
def run_twitter_experiment(model_name, model_display_name, finetune_method="full"):
    print(f"\n{'='*60}")
...
if __name__ == "__main__":
    ...
    for model_name, display_name in models:
        for finetune_method in finetune_methods:
            try:
                result = run_twitter_experiment(model_name, display_name, finetune_method=finetune_method)
